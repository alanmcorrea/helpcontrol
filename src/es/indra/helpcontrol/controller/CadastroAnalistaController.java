...
@Controller
@Scope("view")
public class CadastroAnalistaController implements Serializable {
	...
	public CadastroAnalistaController() {
		limpar();
	}

	public void inicializar() throws DAOException {
		
		//Seta o grupo ANALISTA
		
		grupoAnalista = grupoService.buscarPorID(1L); //ID 1 = ANALISTAS
	...
	public String salvar() throws ServiceException, DAOException {
		...
		//List<Equipe> equipesTarget = (List<Equipe>) this.equipes.getTarget();
		...
		this.usuario.getGrupos().add(grupoAnalista);
		...
		FacesUtil.addInfoMessage("Analista salvo com sucesso!");
		...
		if (editando){
			...
			return "/analistas/PesquisaAnalista";
